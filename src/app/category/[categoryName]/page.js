...
//               Discover our premium collection of {decodedCategory.toLowerCase()} products
//             </p>
//           </div>
//         </div>
//       </div>
...
//                   {/* Badge */}
//                   {product.badge && (
//                     <div className={`absolute top-4 left-4 z-10 px-3 py-1 rounded-full text-white text-sm font-medium ${getBadgeColor(product.badge)} shadow-lg`}>
//                       {product.badge}
//                     </div>
//                   )}
...
const CategoryPage = () => {
  ...
  // This new useEffect hook scrolls the page to the top on initial load.
