        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-12 gap-6">
          <div className="text-center md:text-left">
            ...
            <p className="mt-2 text-lg text-gray-600">
              Explore our entire collection of high-quality products.
            </p>
          </div>
          <div className="relative w-full md:w-80">
            <input
              ...
              className="w-full text-black pl-12 pr-4 py-3 rounded-full border border-gray-300 focus:outline-none focus:ring-2 focus:ring-green-500 transition-colors shadow-sm"
            />
            <Search
              ...
              {currentProducts.map((product) => (
                ...
                >
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    {product.badge && (
                      <span
                        className={`absolute top-4 left-4 px-3 py-1 text-xs font-bold rounded-full shadow-lg ${getBadgeColor(
                          product.badge
                        )} text-white`}
                      >
                        {product.badge}
