...
//   // Auth button component based on session state
//   const AuthButton = () => {
//     if (status === "loading") {
//       return (
//         <div className="flex items-center gap-2">
//           <div className="w-8 h-8 bg-gray-200 rounded-full animate-pulse"></div>
//           <span className="text-sm font-medium hidden lg:block text-gray-400">Loading...</span>
//         </div>
//       );
//     }
...
//   return (
//     <nav className={`w-full bg-white/60 backdrop-blur-md fixed top-0 left-0 transition-all duration-300 ease-in-out z-40 ${
//       isVisible ? "opacity-100 pointer-events-auto" : "opacity-0 pointer-events-none delay-200"
//     }`}>
...
//                   <button className="flex items-center gap-1 text-sm font-medium text-black group-hover:text-green-600">
//                     {item.title}
//                     <ChevronDown className="w-4 h-4" />
//                   </button>
//                   <div className="absolute top-full left-0 mt-2 w-48 bg-white shadow-md rounded-lg opacity-0 group-hover:opacity-100 group-hover:visible invisible transition-all duration-300 z-50">
...
//         {/* Mobile Menu */}
//         <div
//           className={`fixed inset-x-0 top-20 bg-white/90 border-b border-gray-200 lg:hidden transition-all duration-300 ease-in-out ${
//             isMenuOpen ? "opacity-100 visible" : "opacity-0 invisible pointer-events-none"
//           }`}
//           style={{ maxHeight: isMenuOpen ? "calc(100vh - 5rem)" : "0", overflow: "hidden" }}
//         >
...
//                     className="flex justify-between items-center px-3 py-2 rounded-lg text-sm font-medium text-black hover:text-green-600 hover:bg-gray-100 transition-colors w-full"
//                   >
//                     {item.title}
//                     <ChevronDown
...
//                   href="/dashboard"
//                   onClick={handleLinkClick}
//                   className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium text-gray-700 hover:text-green-600 hover:bg-gray-100"
//                 >
//                   <User className="w-4 h-4" />
//                   Dashboard
//                 </Link>
