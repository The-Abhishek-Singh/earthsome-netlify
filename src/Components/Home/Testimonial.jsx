...
//       avatar: "🥗",
//       review:
//         "The quality is unmatched! Their organic selection has completely transformed how I shop for groceries. Highly recommended for anyone who cares about sustainability.",
//     },
//     {
//       id: 3,
//       name: "David Williams",
...
//       avatar: "🍎",
//       review:
//         "Incredible variety of local and eco-friendly products. The staff is knowledgeable and the freshness is always guaranteed. This place is a game-changer!",
//     },
//     {
//       id: 4,
//       name: "Emma Davis",
...
//       avatar: "🥕",
//       review:
//         "I love how they source everything locally and sustainably. The prices are fair and the quality speaks for itself. My go-to place for healthy living!",
//     },
//   ];
...
//   const TestimonialCard = ({ testimonial }) => (
//     <div className="w-full flex-shrink-0 text-center px-8 relative">
//       <div className="absolute top-0 left-1/2 -translate-x-1/2 -mt-4 text-green-300 opacity-20 transform -rotate-12">
//         <Quote size={80} />
//       </div>

//       {/* Avatar */}
//       <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-green-50 flex items-center justify-center text-3xl border-4 border-green-200 transition-all duration-300 ease-in-out transform hover:scale-105 shadow-xl">
//         {testimonial.avatar}
//       </div>

//       {/* Review Text */}
//       <blockquote className="text-xl md:text-2xl text-gray-700 font-medium italic leading-relaxed max-w-3xl mx-auto transition-all duration-300 ease-in-out">
...
//       {/* Customer Info */}
//       <div className="mt-8">
//         <h3 className="text-lg font-bold text-gray-900 mb-1 transition-all duration-300 ease-in-out">
//           {testimonial.name}
//         </h3>
//         <p className="text-sm text-green-600 font-semibold transition-all duration-300 ease-in-out">
//           {testimonial.role}
//         </p>
//       </div>
//     </div>
...
//   return (
//     <div className="w-full bg-gradient-to-br from-white to-green-50 py-16 px-4">
//       <div className="max-w-7xl mx-auto bg-white/50 backdrop-blur-sm rounded-3xl shadow-lg border border-green-200 p-8 md:p-12">
//         <div className="text-center mb-12">
//           <h2 className="text-4xl font-bold text-gray-900 mb-2">
//             What Our Customers Say
//           </h2>
//           <p className="text-gray-600 max-w-2xl mx-auto">
//             Real feedback from real people. See why our products are loved by so
//             many.
//           </p>
//         </div>
...
//             onClick={prevTestimonial}
//             disabled={isTransitioning}
//             className="p-2 bg-white rounded-full transition-all duration-200 transform hover:scale-110 disabled:opacity-50 disabled:cursor-not-allowed shadow-md hover:shadow-lg"
//             aria-label="Previous"
//           >
